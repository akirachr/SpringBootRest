				...
				initialValues={
					{
						...
						deliveryDate: this.props.employee.deliveryDate,
					}
				}
				onSubmit={(values) => (this.send(values))}>
				{formik => (
					<Form noValidate onSubmit={formik.handleSubmit}>
						...
						<TextField
							...
							variant='outlined'
							name='deliveryDate'
							defaultValue={this.props.employee.deliveryDate}
							onChange={formik.handleChange}
							type='date'
						/>
						</Col>
		...
		const employees = this.props.employees.map((employee) => (
			<Card>
				<Accordion.Toggle as={Card.Header} eventKey={employee.id}>
					<Table striped bordered hover className='book'>
						<tr>
							<td class='indent'>・</td>
							<td class='id'>ID: {employee.id}</td>
							<td class='name'>Name: {employee.name}</td>
							<td class='name'>
								<Formik
									initialValues={
										{
